...
<div id="box-login" class="card bounce-in">
    <div class="card-header text-center">
        <a href="<?php echo document::href_ilink(''); ?>"><img src="<?php echo document::href_link(WS_DIR_TEMPLATE . 'images/shopagg-logo.png'); ?>" alt="<?php echo settings::get('store_name'); ?>"></a>
    </div>
