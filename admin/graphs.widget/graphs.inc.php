...
?>
    <style>
        ...
        #chart-sales-monthly .ct-label,
        #chart-sales-daily .ct-label {
            font-size: 12px;
            color: var(--chart-label-color);
        }

        #chart-sales-monthly .ct-series-a .ct-bar,
        #chart-sales-daily .ct-series-a .ct-bar {
            stroke: var(--chart-a-color);
        }

        #chart-sales-monthly .ct-series-b .ct-bar,
        #chart-sales-daily .ct-series-b .ct-bar {
            stroke: var(--chart-b-color);
        }

        #chart-sales-monthly .ct-series-c .ct-bar,
        #chart-sales-daily .ct-series-c .ct-bar {
            stroke: url(#gradient);
        }
    ...
    <script>
        ...
        chart1.on('created', function(ctx) {
            ...
            defs.elem('linearGradient', {
                ...
                .elem('stop', {
                    offset: 0,
                    'stop-color': 'hsla(278, 100%, 42%, .7)'
                })
                .parent().elem('stop', {
                    offset: 1,
                    'stop-color': 'hsla(204, 100%, 50%, .7)'
                });
        });
