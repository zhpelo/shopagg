...
try {
    ...
    echo '<h1>SHOPAGG Installer</h1>' . PHP_EOL . PHP_EOL;
    ...
    $update_file = function ($file) use ($client) {
        $response = $client->call('GET', 'https://raw.githubusercontent.com/SHOPAGG/SHOPAGG/' . PLATFORM_VERSION . '/public_html/' . $file);
    ...
    echo PHP_EOL . '<h2>Complete</h2>' . PHP_EOL
        ...
        . '<p>Check out the <a href="https://shopagg.org/" target="_blank">SHOPAGG</a> website for some great tips. Turn to our <a href="https://shopagg.org/forums/" target="_blank">Community Forums</a> if you have questions.</p>' . PHP_EOL . PHP_EOL;

    if ($_SERVER['SERVER_SOFTWARE'] != 'CLI') {
        echo '<form method="get" action="https://twitter.com/intent/tweet" target="_blank">' . PHP_EOL
            . '  <input type="hidden" value="https://shopagg.org/">' . PHP_EOL
            . '  <div class="form-group">' . PHP_EOL
            . '    <div class="input-group">' . PHP_EOL
            . '      <input type="text" class="form-control" name="text" value="Woohoo! I just installed #SHOPAGG and I am super excited! :)">' . PHP_EOL
